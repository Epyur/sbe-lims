...
// contacts, ekn, mailer, agent, kb (2026-09-10) и llm (2026-09-11), всего девять.
// Правки — сразу во всех; тест живёт в photo-service (authperms_test.go). Общим
// go-модулем не сделан сознательно: у сервисов отдельные модули и отдельные
// Docker-контексты сборки, ради ста строк транспорта переделывать сборку девяти
// сервисов дороже (см. дизайн
