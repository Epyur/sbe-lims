...
// contacts, ekn, mailer, agent). Правки — сразу во всех; тест живёт в
// photo-service (authperms_test.go). Общим go-модулем не сделан сознательно: у
// сервисов отдельные модули и отдельные Docker-контексты сборки, ради ста строк
// транспорта переделывать сборку семи сервисов дороже (см. дизайн
