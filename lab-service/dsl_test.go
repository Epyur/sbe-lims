...
// any/all (2026-08-25) — логическая агрегация по сериям для текстовых Да/Нет-полей
// (прямой запрос пользователя после разбора заявки 287/2026: "если будет выбор
// 'Да если хоть в одной серии Да' и 'Нет, если хоть в одной серии Нет' — это было бы
// удобно"). any — "Да", если хоть одна серия "Да"; all — "Да" только если ВСЕ серии
